...
const DownloadApp = dynamic(() => import("@/components/landing/DownloadApp"), {
  loading: () => (
    <div className="min-h-[300px] flex items-center justify-center text-white/50">
      Loading Section...
    </div>
  ),
  ssr: false,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-left">
            ...
            <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-10 max-w-xl">
              Turn a small entry into life-changing rewards. Grab your ticket,
              upload payment proof, and stand a chance to win premium gadgets,
              luxury gifts, and exclusive prizes â€” delivered straight to your
              door.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="h-12 px-4 bg-gradient-to-br from-[#FFB900] to-[#FF6900] hover:from-[#FFC933] hover:to-[#FF7E1A] text-[#1a0f0a] rounded-xl font-bold text-lg transition-all hover:-translate-y-px hover:scale-105 shadow-[0_4px_20px_rgba(255,105,0,0.35)] hover:shadow-[0_8px_32px_rgba(255,105,0,0.5)] flex items-center justify-center gap-2 cursor-pointer border-none outline-none spell-btn-glow"
              >
                Participate Now <ArrowRightOutlined />
              </button>
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                <a
                  href="https://api.coffretcadeaurdc.tech/download/app"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex"
                >
                  <div className="h-14.5 flex items-center gap-3 bg-linear-to-r from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/10 border border-primary/15 hover:border-primary/30 text-primary px-6 rounded-2xl transition-all hover:scale-105 cursor-pointer backdrop-blur-md">
                    {/* Icon */}
                    ...
                    {/* Text */}
                    <div className="text-left">
                      <div className="text-[10px] text-white/90 font-semibold uppercase tracking-wider leading-none mb-1">
                        Get our app
                      </div>
                      <div className="text-lg font-bold leading-none text-transparent bg-clip-text bg-linear-to-r from-[#ff6900] via-[#ffbb00] to-[#ff6900]">
                        Download Now
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex items-center gap-6 mt-12 text-white/50 text-sm font-medium">
              <span className="flex items-center gap-2">
                <SafetyCertificateFilled className="text-primary text-lg" />{" "}
                Verified Platform
              </span>
              <span className="flex items-center gap-2">
                <TrophyFilled className="text-primary text-lg" /> 100% Random
                Draw
              </span>
            </div>
          </div>
          ...
          <div className="relative w-full aspect-square flex justify-center items-center select-none">
            ...
            <div
              className="absolute w-[360px] h-[360px] bg-gradient-to-tr from-primary/20 to-purple-500/25 rounded-full blur-[90px]"
              style={{ animation: "glow-pulse 4s ease-in-out infinite" }}
            />

            {/* Large Outer dashed Orbit Ring */}
            <div
              className="absolute w-[440px] h-[440px] rounded-full border border-white/5 border-dashed"
              style={{ animation: "orbit-rotate 48s linear infinite" }}
            />

            {/* Inner double styling Orbit Ring */}
            <div
              className="absolute w-[350px] h-[350px] rounded-full border border-primary/10 border-double"
              style={{ animation: "orbit-rotate 28s linear infinite reverse" }}
            />
  ...
  const stats = [
    {
      ...
      icon: (
        <CrownFilled className="text-sm sm:text-xl md:text-2xl text-[#FFB900] group-hover:text-[#FF6900] transition-colors duration-300 animate-pulse" />
      ),
      glowColor: "rgba(254, 147, 1, 0.15)",
      gradient: "from-[#FFB900] via-[#FF6900] to-[#E65E00]",
      iconBg:
        "bg-gradient-to-br from-[#FFB900]/25 to-[#FFB900]/5 border-[#FFB900]/35 group-hover:border-[#FFB900]/65 shadow-[0_0_15px_rgba(254,147,1,0.05)]",
      bgGlow: "bg-[#FFB900]/5",
      borderColor:
        "border-[#FFB900]/15 hover:border-[#FFB900]/45 shadow-[0_0_15px_rgba(254,147,1,0.02)]",
    },
    {
      value: "1,200+",
      label: "Happy Winners",
      icon: (
        <TrophyFilled className="text-sm sm:text-xl md:text-2xl text-[#10b981] group-hover:text-[#059669] transition-colors duration-300" />
      ),
      glowColor: "rgba(16, 185, 129, 0.15)",
      gradient: "from-[#10b981] via-[#059669] to-[#047857]",
      iconBg:
        "bg-gradient-to-br from-[#10b981]/25 to-[#10b981]/5 border-[#10b981]/35 group-hover:border-[#10b981]/65 shadow-[0_0_15px_rgba(16,185,129,0.05)]",
      bgGlow: "bg-[#10b981]/5",
      borderColor:
        "border-[#10b981]/15 hover:border-[#10b981]/45 shadow-[0_0_15px_rgba(16,185,129,0.02)]",
    },
    {
      value: "52",
      label: "Draws per Year",
      icon: (
        <ThunderboltFilled className="text-sm sm:text-xl md:text-2xl text-[#3b82f6] group-hover:text-[#2563eb] transition-colors duration-300" />
      ),
      glowColor: "rgba(59, 130, 246, 0.15)",
      gradient: "from-[#3b82f6] via-[#2563eb] to-[#1d4ed8]",
      iconBg:
        "bg-gradient-to-br from-[#3b82f6]/25 to-[#3b82f6]/5 border-[#3b82f6]/35 group-hover:border-[#3b82f6]/65 shadow-[0_0_15px_rgba(59,130,246,0.05)]",
      bgGlow: "bg-[#3b82f6]/5",
      borderColor:
        "border-[#3b82f6]/15 hover:border-[#3b82f6]/45 shadow-[0_0_15px_rgba(59,130,246,0.02)]",
    },
    {
      value: "100%",
      label: "Transparency",
      icon: (
        <SafetyCertificateFilled className="text-sm sm:text-xl md:text-2xl text-[#a855f7] group-hover:text-[#7c3aed] transition-colors duration-300" />
      ),
      glowColor: "rgba(168, 85, 247, 0.15)",
      gradient: "from-[#a855f7] via-[#7c3aed] to-[#6d28d9]",
      iconBg:
        "bg-gradient-to-br from-[#a855f7]/25 to-[#a855f7]/5 border-[#a855f7]/35 group-hover:border-[#a855f7]/65 shadow-[0_0_15px_rgba(168,85,247,0.05)]",
      bgGlow: "bg-[#a855f7]/5",
      borderColor:
        "border-[#a855f7]/15 hover:border-[#a855f7]/45 shadow-[0_0_15px_rgba(168,85,247,0.02)]",
    },
  ];
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        {stats.map((s) => (
          <div
            ...
            onMouseEnter={(e) =>
              e.currentTarget.style.setProperty("--hover-glow", s.glowColor)
            }
            onMouseLeave={(e) =>
              e.currentTarget.style.setProperty("--hover-glow", "transparent")
            }
          >
            {/* Glow Decorative Blob */}
            <div
              className={`absolute -top-12 -right-12 w-24 h-24 rounded-full blur-2xl opacity-10 transition-opacity duration-500 group-hover:opacity-20 ${s.bgGlow}`}
            />

            {/* Custom Icon Circle */}
            <div
              className={`w-9 h-9 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl ${s.iconBg} border flex items-center justify-center mb-3 sm:mb-5 md:mb-6 group-hover:scale-110 transition-transform duration-500`}
            >
              {s.icon}
            </div>
            ...
            {/* Gradient Number */}
            <div
              className={`text-2xl sm:text-3xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r ${s.gradient} mb-1 sm:mb-2 tracking-tight group-hover:scale-105 transition-transform duration-300`}
            >
              {s.value}
            </div>
    ...
    <Section id="about" className="mt-6 md:mt-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
        ...
        <div>
          <SectionTitle
            eyebrow="About Us"
            title="Your trusted platform for weekly wins."
            align="left"
          />
          <p className="text-white/70 text-lg leading-relaxed mb-8 -mt-10">
            Unlike traditional lotteries, Gift Box operates with 100%
            transparency. Every draw is conducted live, every winner is
            verified, and every prize is guaranteed to be brand new and
            authentic. We handle the logistics so all you have to do is enjoy
            your win.
          </p>
          <ul className="space-y-4">
            {[
              "No hidden fees or subscriptions",
              "Guaranteed weekly prize fulfillment",
              "Secure payment verification",
            ].map((item, i) => (
              <li
                key={i}
                className="flex items-center gap-3 text-white/80 font-medium text-lg"
              >
...
function HowItWorks() {
  const steps = [
    {
      n: "01",
      title: "Browse Active Draws",
      desc: "See this week's premium prize, ticket price, and time remaining.",
      icon: <StarFilled />,
    },
    {
      n: "02",
      title: "Upload Proof",
      desc: "Pay via secure external methods and upload your screenshot to enter.",
      icon: <SafetyCertificateFilled />,
    },
    {
      n: "03",
      title: "Win Big",
      desc: "Winners are drawn randomly and notified immediately for prize delivery.",
      icon: <TrophyFilled />,
    },
  ];
  return (
    <Section
      id="how-it-works"
      className="bg-surface/30 border-y border-white/5 relative"
    >
      ...
      <SectionTitle
        ...
        subtitle="No complicated rules. Grab a ticket, upload your proof, and wait for the draw."
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((s) => (
          ...
          >
            <div className="absolute -right-10 -top-10 text-9xl font-black text-white/[0.03] group-hover:text-primary/10 transition-all duration-500 transform group-hover:scale-110">
              {s.n}
            </div>
...
function WhyUs() {
  const cards = [
    {
      icon: (
        <SafetyCertificateFilled className="text-2xl transition-colors duration-300 text-primary group-hover:text-white" />
      ),
      title: "Secure transactions",
      desc: "Pay safely via trusted mobile platforms (M-Pesa, Orange Money, Airtel Money). We only verify the transaction receipt, keeping your bank details 100% private.",
    },
    {
      icon: (
        <CheckCircleFilled className="text-2xl transition-colors duration-300 text-primary group-hover:text-white" />
      ),
      title: "Transparent draw system",
      desc: "Every entry is recorded, every ticket number is verifiable, and all draws are live-announced. No hidden shortcuts, no preferences.",
    },
    {
      icon: (
        <TrophyFilled className="text-2xl transition-colors duration-300 text-primary group-hover:text-white" />
      ),
      title: "Fast reward delivery",
      desc: "Verified winners are processed instantly. Your brand-new, sealed prize is delivered completely free of charge to your door.",
    },
  ];
  return (
    <Section id="why-us">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
        ...
        <div>
          <div className="text-left mb-10">
            ...
            <h2 className="m-0 text-white text-3xl md:text-4xl lg:text-5xl font-black leading-[1.1] tracking-tighter mb-4 lg:whitespace-nowrap">
              Built on trust, not just luck.
            </h2>
            <p className="mt-4 mb-0 text-white/60 text-base leading-relaxed">
              Gift Box operates with 100% transparency. We document every draw,
              name every winner, and manage all logistics for a premium
              experience.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {cards.map((c, i) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-white text-lg font-bold mb-1.5 group-hover:text-primary transition-colors duration-300">
                    {c.title}
                  </h3>
