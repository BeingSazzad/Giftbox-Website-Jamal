...
export default function DownloadApp() {
  return (
    <Section id="app">
        ...
        <div className="relative z-10 px-8 py-12 md:px-14 md:py-16 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-md text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white leading-[1.1] mb-5 tracking-tight">
              Take Gift Box <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6900] via-[#ffbb00] to-[#ff6900]">
                everywhere you go.
              </span>
            </h2>
            <p className="text-white/50 text-base leading-relaxed mb-8 max-w-sm">
              Never miss a draw. Upload payment proofs in one tap, track your
              entries, and get instant notifications when you win.
            </p>
      ...
      >
        <div className="h-18 flex items-center gap-3 bg-linear-to-r from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/10 border border-primary/15 hover:border-primary/30 text-primary px-6 rounded-2xl transition-all hover:scale-105 cursor-pointer backdrop-blur-md">
          ...
          <div className="text-left">
            ...
            <div className="text-2xl font-bold leading-none text-transparent bg-clip-text bg-linear-to-r from-[#ff6900] via-[#ffbb00] to-[#ff6900]">
              Download Now
            </div>
          </div>
          ...
          {/* Right: Phone Mockup */}
          <div className="relative w-full max-w-[500px] md:w-[500px] lg:w-[540px] shrink-0 select-none transform hover:scale-[1.02] transition-transform duration-700">
            {/* Outer glow */}
...
function PlayLogo() {
  return (
    <svg width="32" height="32" viewBox="0 0 24 24">
      <path
        d="M3.6 1.8c-.3.3-.4.7-.4 1.2v18c0 .5.1.9.4 1.2L13.4 12 3.6 1.8z"
        fill="#FE9301"
      />
      <path
        d="M16.8 8.4 13.4 12l3.4 3.6 4.2-2.4c1.2-.7 1.2-2.4 0-3.1l-4.2-2.7z"
        fill="#FFB900"
      />
      <path
        d="M3.6 1.8 13.4 12l3.4-3.6L4.6 1.4c-.3-.2-.7-.1-1 .4z"
        fill="#34A853"
      />
      <path
        d="M13.4 12 3.6 22.2c.3.5.7.6 1 .4l12.2-7L13.4 12z"
        fill="#EA4335"
      />
    </svg>
  );
